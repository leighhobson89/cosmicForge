...
export function initialiseDescriptions() {
    ...
    infoTooltipDescriptions = {
        ...
        info_launchPadHeader: 'The Launch Pad is where rockets are built.  You must build all modules of each rocket for it to be considered built.  Once you click on Launch Pad you can thien click on the rocket you want more info about, and there you can launch it, and select a destination for it to go.',
