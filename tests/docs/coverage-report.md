...
271 individual test cases are identified across all areas. **257 Playwright specs are implemented and passing** across 16 areas. The 7 amber areas are covered only by legacy smoke tests, which prove a path exists but assert almost nothing about branches, boundaries or failure modes.
...
| 🟢 | [Localization](areas/localization.md) | High | 17 | **84** | — |
