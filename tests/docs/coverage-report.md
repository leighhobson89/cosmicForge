...
| | Areas | Share |
|---|---:|---:|
| 🔴 Red — no coverage | 25 | 58% |
| 🟠 Amber — partial / smoke only | 8 | 19% |
| 🟢 Green — comprehensive | 10 | 23% |
| **Total functional areas** | **43** | |

262 individual test cases are identified across all areas. **114 Playwright specs are implemented and passing** across 10 areas. The 8 amber areas are covered only by legacy smoke tests, which prove a path exists but assert almost nothing about branches, boundaries or failure modes.
...
These 10 areas would each cause serious, often unrecoverable player harm if they regressed, and none has any automated test today.
...
| [Localization](areas/localization.md) | Foundation | Language resolution, switching, persistence and full-catalogue integrity across five languages. |
...
| [Diplomacy](areas/diplomacy.md) | Interstellar | Impression mechanics and every negotiation outcome branch before conquest. |
...
| [Demo Build Lockdowns](areas/demo-build.md) | Presentation & Shell | Feature gating for the demo variant. A leak here gives away the full game. |
...
| 🔴 | [Localization](areas/localization.md) | High | 8 | — | — |
...
| 🟠 | [Energy & Power Grid](areas/energy.md) | High | 7 | — | energyMid.test.js |
...
| 🔴 | [Diplomacy](areas/diplomacy.md) | High | 6 | — | — |
...
| 🔴 | [Cosmic Rip](areas/cosmic-rip.md) | Medium | 7 | — | — |
...
| 🔴 | [Cosmicopedia & Help](areas/cosmicopedia.md) | Low | 5 | — | — |
| 🔴 | [Demo Build Lockdowns](areas/demo-build.md) | High | 6 | — | — |
